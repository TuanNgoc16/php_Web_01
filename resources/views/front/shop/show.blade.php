        ...
        <div class="row">
            ...
            <div class="col-lg-9">
               <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="product-thumbs">
                         <div class="product-thumbs-track ps-slider owl-carousel"> <!--Zoom ảnh-->
               ...
               <div class="product-tab">
                  <div class="tab-item"> <!--Phần Bình Luận -->
                               ...
                               <div class="specification-table">
                                  <table>
                                    ...
                                    <tr>
                                         ...
                                         <td>
                                            <div class="p-size"> @foreach(array_unique(array_column($product->productDetails->toArray(),'size')) as $productSize)
                                                                     {{$productSize}},
                                                @endforeach
                                            </div>
                                         </td>
                                        ...
                                        <td>
                                            @foreach(array_unique(array_column($product->productDetails->toArray(),'color')) as $productColor)
                                                <div class="cc-item">
                                                    ...
                                                    <span for="cc-{{$productColor}}" class="cc-{{$productColor}}"></span>
                                                </div>
                                            @endforeach
                                        </td>
                                    </tr>
...
{{--                                          product-single/avatar-1.png--}}
    ...
    <!--Prouduct Shop Section End-->

    <!--Related Prouduct Begin-->
